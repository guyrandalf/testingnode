...
var _movieDataJs = require("./MovieData.js");
var _movieDataJsDefault = parcelHelpers.interopDefault(_movieDataJs);
var _moviesListingJs = require("./MoviesListing.js");
var _moviesListingJsDefault = parcelHelpers.interopDefault(_moviesListingJs);
var _utilsJs = require("./utils.js");
const cardsContainerNode = document.querySelector(".cards-container");
const movieData = new (0, _movieDataJsDefault.default)();
const moviesListing = new (0, _moviesListingJsDefault.default)(movieData, cardsContainerNode);
moviesListing.init();
...
(0, _utilsJs.footerDate)();

},{"./MovieData.js":"dCSem","./MoviesListing.js":"58NH4","./utils.js":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dCSem":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"58NH4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("./utils.js");
class MoviesListing {
    ...
    prepareTemplate(parent, template, list) {
        ...
        list.map((movie)=>{
            ...
            let movieGenreNames = [];
            if (!this.isFavorite) movieGenreNames = this.movieData.movieGenreNames(this.movieGenres.genres, movie.genre_ids);
            else movieGenreNames = movie.genres.map((genre)=>genre.name);
    ...
    async showMovies(selector, isSearch, queryString = "", isFavorite) {
        ...
        if (!this.isSearch && !this.isFavorite) this.prepareTemplate(this.parentNode, template, this.discoverMovies.results);
        else if (this.isFavorite) {
            this.favLocal = await (0, _utilsJs.getLocalStorage)("favorites");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gEwwu","1SICI"], "1SICI", "parcelRequire5a21")
